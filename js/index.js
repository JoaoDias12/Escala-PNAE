...
function distribuirPessoas() {
  ...
  function getAvailablePeople(flight, day) {
    ...
    // Priorizar pessoas com o Time H1 primeiro para 0930 e 0950
    if (['Miami - 0930', 'Nova York - 0950'].includes(flight)) {
      availablePeople = Object.keys(peoples)
        .filter(personKey => {
          ...
          return (
            ...
            !(
              flight === 'Nova York - 0950' &&
              wasPersonAssignedToFlight(date, 'Nova York - 0950', personKey)
            )
          )
        })
      ...
      // Se não é 0930 ou 0950, pegar pessoas normais
  ...
  function assignPeople(flight, availablePeople, dateString) {
    ...
    if (availablePeople.length >= 2) {
      ...
      if (flight === 'Miami - 0930' || flight === 'Nova York - 0950') {
        ...
        const prev0950 = assignments[prevDateString]
          ? assignments[prevDateString]['Nova York - 0950'] || []
          : []
      ...
      if (
        ...
        (flight === 'Nova York - 0950' || flight === 'Miami - 0930')
      ) {
      ...
      (flight === 'Miami - 0930' || flight === 'Nova York - 0950')
    ) {
